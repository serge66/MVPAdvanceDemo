...
import com.example.lsj.mvpdemo.base.IMultiplePresenter;
 ...
 */
public class MultipleInterfaceActivity extends BaseMVPActivity<IMultiplePresenter>
    ...
    private Button btn;
    private TextView tv;
    private SingleInterfaceContract.Presenter singleInterfacePresenter;
    private MultipleInterfaceContract.Presenter multipleInterfacePresenter;
    ...
    @Override
    protected IMultiplePresenter createPresenter() {
        IMultiplePresenter multiplePresenter = new MultiplePresenter(this);
