 ...
 */
public class MultiplePresenter<T extends IView> extends BasePresenter<T> implements IMultiplePresenter<T>{
    public T mView;
...
//    }
    ...
    @Override
    public void addPresenter(IPresenter<T> ap) {
        ap.attachView(mView);
        presenters.add(ap);
    }
}
