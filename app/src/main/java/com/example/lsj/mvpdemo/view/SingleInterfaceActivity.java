 ...
 */
public class SingleInterfaceActivity extends BaseMVPActivity<SingleInterfaceContract.Presenter>
    ...
    @Override
    protected SingleInterfaceContract.Presenter createPresenter() {
